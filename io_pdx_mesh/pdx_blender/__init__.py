...
from . import blender_import_export, blender_ui, rigging_tools  # FORK: added rigging_tools

importlib.reload(blender_import_export)
importlib.reload(blender_ui)
importlib.reload(rigging_tools)  # FORK: reload our tools too
...
# FORK: also scan our own module for operators/panels
for _name, obj in inspect.getmembers(rigging_tools, inspect.isclass):
    if obj.__module__.startswith(__name__) and hasattr(obj, "bl_rna"):
        classes.append(obj)
